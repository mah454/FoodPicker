...
public class PersianDateConverter {
    private int irYear; // Year part of a Persian date
    private int irMonth; // Month part of a Persian date
    private int irDay; // Day part of a Persian date
     ...
     * @param day   int
     */
    public PersianDateConverter(int year, int month, int day) {
